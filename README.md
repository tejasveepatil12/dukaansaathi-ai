...
_A submission for the Paytm Build for India AI Hackathon – Mumbai Edition (Merchant Growth AI Track)_
...
_Open [http://localhost:3000](http://localhost:3000?utm_source=gemini) in your browser to view the application._
